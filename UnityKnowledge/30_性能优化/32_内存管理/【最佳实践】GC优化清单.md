...
status: 待验证
validation: Demo验证
related: ["[[【设计原理】GC工作原理深度解析]]", "[[【笔记】字符串拼接方式对比]]", "[[../../31_代码优化/【最佳实践】Update优化清单]]"]
author: llm
---
...
Unity GC优化的完整实践清单，涵盖字符串优化、集合预设容量、对象池复用、委托缓存、协程优化、资源加载缓存、Unity API优化、数组优化八大类别，每个类别均提供错误示例和推荐写法。配套GC检测工具的使用方法和自动化检测代码。
...
- 深入学习: [Unity内存管理](../../35_高级主题/【设计原理】Unity内存管理.md)
- 踩坑记录: [内存泄漏模式](【踩坑】内存泄漏模式.md)
- 性能数据: [字符串拼接方式对比](../../30_性能优化/32_内存管理/【笔记】字符串拼接方式对比.md)
