...
status: 待验证
validation: Demo验证
related: ["[[【笔记】foreach vs for]]", "[[【设计原理】为什么foreach比for慢]]", "[[【最佳实践】Update优化清单]]"]
author: llm
---
...
LINQ各操作与手写for循环的性能对比测试数据，涵盖Where筛选、Select投影、OrderBy排序等常见操作。核心结论：LINQ比手写循环慢10-30倍且产生大量GC分配，绝对禁止在Update中使用。文档同时列出可以酌情使用LINQ的场景。
