...
status: 待验证
validation: Demo验证
related: ["[[../../【教程】性能分析工具]]", "[[【最佳实践】UI性能优化速查]]", "[[【性能数据】UGUI DrawCall影响因素全面测试]]"]
author: llm
---
...
使用Unity Frame Debugger进行系统化渲染诊断的完整流程教程，从启用工具、建立基线、逐层分析DrawCall，到定位未合批原因和生成优化建议报告。包含UI合批检查、Shader Pass分析、过度绘制分析等进阶诊断技巧，以及自动化诊断脚本和批处理优化建议生成器。
...
- [[【最佳实践】UI性能优化速查]] - UI 优化详细指南
- [[【最佳实践】3D渲染优化指南]] - 3D 渲染优化
- [[【性能数据】UGUI DrawCall影响因素全面测试]] - DrawCall 数据
