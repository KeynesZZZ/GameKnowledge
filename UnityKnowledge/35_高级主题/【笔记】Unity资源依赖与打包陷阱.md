...
- **图集（SpriteAtlas）**：late binding 模式下SpriteAtlas 易被重复引用，单独成包；UI 侧图集冗余的细节见 [[【笔记】UGUI性能优化实战总览]]。
...
- [[【笔记】Unity客户端面试题]] — 第 26 题 AB 压缩选型（LZMA vs LZ4）的深度展开
...
- [[【笔记】UGUI性能优化实战总览]] — UI 图集/SpriteAtlas 冗余的 UGUI 视角
