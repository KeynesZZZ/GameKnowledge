...
related: ["[[【系统架构】场景管理]]", "[[【系统架构】音频系统]]", "[[【教程】Unity脚本生命周期]]"]
---
...
本文档从**架构设计角度**讲解输入管理系统，重点在于系统架构和接口设计。封装Unity新输入系统（Input System包），提供按键重映射、多设备支持和统一的输入管理器实现。

**底层系统详解**：参见 [[../20_核心系统/24_输入系统/【源码解析】Input System底层实现机制]]
