...
status: 待验证
validation: Demo验证
related: ["【最佳实践】网络同步模型", "【代码片段】TCP客户端", "【最佳实践】网络同步模型"]
author: llm
---
...
讲解TCP/UDP Socket编程的基础知识，涵盖TCP服务器与客户端的创建、异步通信模式、消息协议设计、粘包处理等网络编程核心概念。

**相关文档**：[[【最佳实践】网络同步模型]]、[[【代码片段】TCP客户端]]、[[【最佳实践】网络同步模型]]
