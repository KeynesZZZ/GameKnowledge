---
title: 【笔记】IK系统实现
tags: ["Unity", "动画", "动画系统", "IK", "源码解析", "设计原理"]
category: 核心系统/动画系统
...
status: 待验证
validation: 未经测试
related: ["【教程】动画混合与过渡", "【笔记】动画事件与回调", "【设计原理】Animator深度解析"]
author: llm
---
...
深入解析Unity IK系统的底层实现，对比FK与IK、CCD与FABRIK算法原理，提供手部IK、脚部自适应地形、抓取系统等完整实战代码。

**相关文档**：[[【教程】动画混合与过渡]]、[[【笔记】动画事件与回调]]、[[【设计原理】Animator深度解析]]、
...
- [动画混合与过渡](./【教程】动画混合与过渡.md)
- [动画事件与回调](./【笔记】动画事件与回调.md)
