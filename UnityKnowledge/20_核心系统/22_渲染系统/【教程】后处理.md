...
description: URP后处理系统配置与使用
unity_version: 2021.3+
status: 待验证
validation: Demo验证
related: ["【教程】渲染管线基础", "【教程】后处理效果实现", "【最佳实践】URP常用配置"]
author: llm
---
...
详解URP Volume后处理框架，涵盖Volume组件配置、内置效果（Bloom、DOF、色彩校正等）的使用方法，以及通过Renderer Feature实现自定义后处理的流程。

**相关文档**：[[【教程】渲染管线基础]]、[[【教程】后处理效果实现]]、[[【最佳实践】URP常用配置]]
