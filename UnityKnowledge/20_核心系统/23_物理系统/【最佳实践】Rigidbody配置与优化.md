...
status: 待验证
validation: Demo验证
related: ["【最佳实践】物理系统性能优化", "【笔记】碰撞检测模式对比", "【实战案例】2D物理系统专项"]
author: llm
---
...
总结Rigidbody组件的最佳配置实践，涵盖插值模式、碰撞检测模式选择、质量设置、约束条件、Sleep机制等关键参数的推荐值与优化策略。

**相关文档**：[[【最佳实践】物理系统性能优化]]、[[【笔记】碰撞检测模式对比]]、[[【实战案例】2D物理系统专项]]
